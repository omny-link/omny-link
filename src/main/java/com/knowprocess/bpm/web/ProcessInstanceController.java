...
public class ProcessInstanceController {
	...
	public @ResponseBody ProcessInstance startNewInstance(
		...
		ProcessInstance pi = new ProcessInstance(processEngine.getRuntimeService().startProcessInstanceById(instanceToStart.getProcessDefinitionId(), instanceToStart.getBusinessKey(), instanceToStart.getProcessVariables()));
		return pi;
	}
