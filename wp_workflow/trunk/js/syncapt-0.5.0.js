    ...
    $('[data-p-combo]').each(function(i,d) {
      ...
      $(d).autocomplete({
        change: function( event, ui ) {
          console.debug('Change event '+event+' for '+event.target.id+', new val '+event.target.value);
        ...
        select: function( event, ui ) {
          console.debug('select event '+event+' for '+event.target.id+', selecting '+ui.item.label);
      ...
      $(d).focus(function(ev) { 
        console.debug('focus on '+ev.target.id+' opening drop down'); 
