        ...
        $(document).ready(function() {
          console.info('Document ready handler...');
          loadTemplates();
        });
        function loadTemplates() {
          $.getJSON(
              ...
              function(templates) {
                console.info("Have "+templates.length+" templates: "+templates);
                $('#templates-ctl').empty();
...
//          console.log('successfully uploaded definition');
  ...
  this.instanceBusinessKey = function(instanceId) {
    ...
    $.each(instances, function(i,d) {
      console.info('checking '+d.id+' matches '+instanceId+': '+(d.id == instanceId));
      if (d.id == instanceId) {
