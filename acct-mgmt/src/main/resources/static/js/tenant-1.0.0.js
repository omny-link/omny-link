...
//        });
  ...
  mergeTenants: function() {
    console.info('mergeTenants');
    ractive.set('tenant1',ractive.get('tenants[0]'));
    ractive.set('tenant2',ractive.get('tenants[1]'));
    ractive.set('mergedTenant',ractive.get('tenants[2]'));
//    alert('Sorry merge of tenants is not yet implemented');
    $('#mergeModal').modal({});
  },
  oninit: function() {
    console.log('oninit');
