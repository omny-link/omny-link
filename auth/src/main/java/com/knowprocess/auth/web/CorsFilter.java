package com.knowprocess.auth.web;
            ...
            if (isAllowed(origin)) {
                ...
                if ("OPTIONS".equals(request.getMethod())) {
                    ...
                    addOnlyOneHeader(
                            response,
                            ALLOW_HEADERS,
                            "Accept, Accept-Encoding, Accept-Language, Access-Control-Request-Headers, Access-Control-Request-Method, Authorization, Cache-Control, Connection, Content-Type, Host, Location, Origin, Referer, User-Agent, X-Requested-With");
