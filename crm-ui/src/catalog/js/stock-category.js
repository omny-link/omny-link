...
//      console.log('ready to save stockCategory'+JSON.stringify(tmp)+' ...');
      $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          case 201:
            ...
            ractive.set('currentIdx', ractive.get('stockCategories').push(ractive.get('current'))-1);
            ractive.edit(ractive.get('current'));
            break;
          case 204:
  ...
  select: function(stockCategory) {
    ...
    if (stockCategory.owner == undefined || stockCategory.owner == '')
      stockCategory.owner = ractive.get('profile.username');
