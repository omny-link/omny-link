...
export var BaseRactiveWithSupportServices = BaseRactive.extend({
  /* 
  ...
  toggleShowConfidentialNotes: function(btn) {
  ...
  toggleShowFavoriteNotes: function(btn) {
  ...
  toggleNoteConfidentiality: function(idx) {
  ...
  toggleNoteFavorite: function(idx) {
