 ...
 *  the License.
 ******************************************************************************/
import { BaseRactiveWithSupportServices } from "../../js/support";
import { CustMgmtClient } from "./cust-mgmt-client";
const DEFAULT_INACTIVE_STAGES = 'cold,complete,on hold,unqualified,waiting list';

var ractive = new BaseRactiveWithSupportServices({
  cm: new CustMgmtClient({
    server: $env.server,
      ...
      data: {
        ...
        stdPartials: [
          { "name": "activityCurrentSect", "url": "/partials/activity-current-sect.ractive"},
          { "name": "accountFinancials", "url": "/partials/account-financials.ractive" },
          { "name": "accountListSect", "url": "/partials/account-list-sect.ractive" },
          { "name": "accountListTable", "url": "/partials/account-list-table.ractive" },
          { "name": "companyLeiLink", "url": "/partials/lei-link-uk-company.ractive" },
          { "name": "currentAccountSect", "url": "/partials/account-current-sect.ractive" },
          { "name": "currentContactAccountSect", "url": "/partials/contact-current-account-sect.ractive" },
          { "name": "currentDocumentListSect", "url": "/partials/current-document-list-sect.ractive" },
          { "name": "currentNoteListSect", "url": "/partials/current-note-list-sect.ractive" },
          { "name": "currentOrderListSect", "url": "/partials/contact-current-order-list-sect.ractive" },
          { "name": "currentTaskListSect", "url": "/partials/task-list-sect.ractive" },
          { "name": "customActionModal", "url": "/partials/custom-action-modal.ractive" },
          { "name": "fieldExtension", "url": "/partials/field-extension.ractive"},
          { "name": "helpModal", "url": "/partials/help-modal.ractive" },
          { "name": "profileArea", "url": "/partials/profile-area.ractive" },
          { "name": "socialModal", "url": "/partials/social-modal.ractive" },
          { "name": "sidebar", "url": "/partials/sidebar.ractive" },
          { "name": "titleArea", "url": "/partials/title-area.ractive" },
          { "name": "navbar", "url": "/partials/account-navbar.ractive" },
          { "name": "supportBar", "url": "/partials/support-bar.ractive" }
        ],
        workPartials: [
          { "name": "currentTaskListSect", "url": "/partials/task-list-sect.ractive" },
          { "name": "instanceListSect", "url": "/partials/instance-list-sect.ractive" },
          { "name": "taskListTable", "url": "/partials/task-list-table.ractive" }
        ],
