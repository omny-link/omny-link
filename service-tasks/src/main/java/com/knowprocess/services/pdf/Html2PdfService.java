...
@Service
public class Html2PdfService implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        String input = (String) data.getValue(execution);
    ...
    public void execute(String var, OutputStream outputStream) {
        try {
            ...
            try {
                ...
                // cssResolver.addCss(
                // "ol { list-style: decimal !important; } ul { list-style: disc
                // !important; }",
                // true);
