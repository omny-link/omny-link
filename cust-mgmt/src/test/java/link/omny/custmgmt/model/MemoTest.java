...
public class MemoTest {
    ...
    public void testSetPlainContent() {
        Memo memo = new Memo();
        memo.setRichContent(
                "<h1>The War of the Worlds</h1><br/><h2>By H.G. Wells</h2>");
    ...
    public void testSetDefaultSignatories() {
        Memo memo = new Memo();
        memo.getSignatories()
                .add(new MemoSignatory(
                        "${owner.getJsonObject(0).getString('fullName','')}",
                        "${owner.getJsonObject(0).getString('email','')}", 250,
                        250, 1));
        memo.getSignatories()
        ...
        assertEquals(250,
                memo.getSignatories().get(0).getSignHereTabs().get(0).getX());
        assertEquals(250,
                memo.getSignatories().get(0).getSignHereTabs().get(0).getY());
        assertEquals(1, memo.getSignatories().get(0).getSignHereTabs().get(0)
                .getPage());

        assertEquals(250,
                memo.getSignatories().get(1).getSignHereTabs().get(0).getX());
        assertEquals(340,
                memo.getSignatories().get(1).getSignHereTabs().get(0).getY());
        assertEquals(1, memo.getSignatories().get(1).getSignHereTabs().get(0)
                .getPage());
    ...
    public void testToCsv() {
        ...
        assertEquals(
                ",BookRecommendation,Your latest recommended reading,Draft,,<h1>The War of the Worlds</h1>"
